...
var prevTimer = 0; //when last time our timer went off
var interval = 3000;
...
//turn on millis timer, 1000 millisecond = 1 second
if(startTimer == true){
  //want to see or not see when correct
...
currentOption = -1;
startTimer = true;
prevTimer = millis(); //this here resets the millis, from this point on start the set interval
  }
