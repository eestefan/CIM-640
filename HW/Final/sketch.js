...
//instructions
var instuctionsPigHitZoneX = 400;
var instuctionsPigHitZoneY = 160;
var instuctionsPigHitZoneSize = 240;
//Page2 catHitZone
var catHitZoneX = 100;
var catHitZoneY = 160;
...
function preload(){
  ...
  //instructions
  instructionsPigSound = loadSound("sounds/instructions-pig-sound.m4a")
  ...
  homeSounds = [catSound,dogSound,birdSound,pigSound,cowSound,chickenSound,frogSound,grasshopperSound,dolphinSound,whaleSound];
...
function draw() {
  ...
  //Instructions page
    ...
    text("You will know it is correct when",50,180);
    text("the sound changes.",50,210);
